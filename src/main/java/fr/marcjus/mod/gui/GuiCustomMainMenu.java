...
public class GuiCustomMainMenu extends GuiScreen{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + i * 4, 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + i * 4, 98, 20, I18n.format("menu.quit")));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + i * 4));
     ...
     */
    private void addSingleplayerMultiplayerButtons(int j, int i)
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, j, I18n.format("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, j + i * 1, I18n.format("menu.multiplayer")));
        this.buttonList.add(new GuiButton(20, this.width / 2 - 100, j + i * 3, I18n.format("menu.main.controls")));
        this.localServer=this.addButton(new GuiButton(14, this.width / 2 + 2, j + i * 2, 98, 20, I18n.format("menu.localserver")));
        this.buttonList.add(modButton = new GuiButton(6, this.width / 2 - 100, j + i * 2, 98, 20, I18n.format("fml.menu.mods")));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 14)
        {
            FMLClientHandler.instance().connectToServer(this, new ServerData("Local Server", "127.0.0.1:25565", false));
        }
